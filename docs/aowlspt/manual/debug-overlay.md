---
title: "The in-game debug overlay"
---

# The in-game debug overlay (`debugUi` / `debugEsp`)

::: info From the aowlspt repository — [`docs/DEBUG-OVERLAY.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/DEBUG-OVERLAY.md)
...
* **Clone, never create.** Every label is
  ...
  `il2cpp_object_new` or <code>AddComponent&lt;T&gt;</code>.
...
See [`abi/aowlspt_debugui.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_debugui.h) for the RVAs, the disassembled evidence for each
...
([`abi/aowlspt_region.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_region.h)):
