---
title: "Headless and unattended running"
---

# Headless and unattended running — what is actually possible

::: info From the aowlspt repository — [`docs/HEADLESS.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/HEADLESS.md)
...
**Whether the game client can be run without a screen or a person — asked, measured, and answered no, with what is possible instead.**
...
## Option 4 — no client at all: [`tools/headless.py`](https://github.com/aoughwl/aowlspt/blob/main/tools/headless.py)
...
* `admintrader` — [`tools/acceptance_admintrader.py`](https://github.com/aoughwl/aowlspt/blob/main/tools/acceptance_admintrader.py), the mod loaded into
...
> diagnostic **<code>"The command-line parameter 'adapter' has been removed. Please &gt; use 'monitor' instead."</code>** — which is Unity's own message about `-monitor`.
...
it appears. That is now built: **[`tools/offscreen.py`](https://github.com/aoughwl/aowlspt/blob/main/tools/offscreen.py)**, and `tools/harness.py
