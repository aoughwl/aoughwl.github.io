---
title: "The live inspector as a product"
---

# The live inspector as a first-class product

::: info From the aowlspt repository — [`docs/INSPECTOR-PRODUCT.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/INSPECTOR-PRODUCT.md)
...
Source of record: [`host/Aowlspt.Host.Il2Cpp/inspect.nim`](https://github.com/aoughwl/aowlspt/blob/main/host/Aowlspt.Host.Il2Cpp/inspect.nim) (~4,200 lines), read in
...
([`host/Aowlspt.Host.Il2Cpp/inspect.nim`](https://github.com/aoughwl/aowlspt/blob/main/host/Aowlspt.Host.Il2Cpp/inspect.nim)) gated by two independent flags in
...
that <code>scry &lt;verb&gt;</code> doesn't feel like typing overhead in a REPL used
