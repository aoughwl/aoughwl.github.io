---
title: "UIHOOKS \u2014 subscribe to a screen"
---

# UIHOOKS — subscribe to a screen instead of hunting for it

::: info From the aowlspt repository — [`docs/UIHOOKS.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/UIHOOKS.md)
...
**Files:** [`abi/aowlspt_uihooks.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_uihooks.h) (the site table),
[`host/Aowlspt.Host.Il2Cpp/uihooks.nim`](https://github.com/aoughwl/aowlspt/blob/main/host/Aowlspt.Host.Il2Cpp/uihooks.nim) (the registry + dispatch),
...
2. gets <code>&lt;feature&gt;OnScreenShown(self)</code> called with the live screen;
...
|---|---|---|---|
| **screen shown** | "the screen I want to edit is on screen NOW, here it is" | `uihooks.nim` (this doc) | `uihWant(site)` → <code>&lt;feature&gt;OnScreenShown(self)</code> |
