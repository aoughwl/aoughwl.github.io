---
title: "The audio path, resolved offline"
---

# AUDIORAY_RVA — the audio path into EFT, resolved offline

::: info From the aowlspt repository — [`docs/AUDIORAY_RVA.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/AUDIORAY_RVA.md)
...
**The second half of the raytraced-audio track: the addresses in the client's own audio path that a computed occlusion gain would have to be applied at.**
...
<code>il2cpp&#95;resolve.py ... bytes &lt;RVA&gt;</code>: all eight are real bodies in the `il2cpp`
...
### Fields (from `Il2CppMetadataRegistration.fieldOffsets`, via [`tools/fldoff.py`](https://github.com/aoughwl/aowlspt/blob/main/tools/fldoff.py))
