---
title: "Squad-shared objectives"
---

# Bot AI — Squad-Shared Objectives (design, ready to build)

::: info From the aowlspt repository — [`docs/BOT_AI_OBJECTIVES.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/BOT_AI_OBJECTIVES.md)
...
Written as ready to build, and gated on a live measurement that never came. Read it as a design, not as behaviour.
:::

**A design for giving a bot squad one shared objective instead of per-bot goals. Never built.**
...
- **Server** [`mods/tarkov/emu/orbit.nim`](https://github.com/aoughwl/aowlspt/blob/main/mods/tarkov/emu/orbit.nim) + [`mods/sain/server/dispatch.nim`](https://github.com/aoughwl/aowlspt/blob/main/mods/sain/server/dispatch.nim):
...
- **Client** [`mods/sain/client/bridge.nim`](https://github.com/aoughwl/aowlspt/blob/main/mods/sain/client/bridge.nim) + `core/decide.nim`: reads bots (fact
...
## Model ([`mods/sain/core/objective.nim`](https://github.com/aoughwl/aowlspt/blob/main/mods/sain/core/objective.nim), new)
...
## Quest POIs
Best source = **waypoints** (<code>mods/waypoints/data/&lt;map&gt;.json</code>, ~8556 real
...
## Config ([`mods/sain/config.json`](https://github.com/aoughwl/aowlspt/blob/main/mods/sain/config.json), flat keys, Bot-AI-named)
