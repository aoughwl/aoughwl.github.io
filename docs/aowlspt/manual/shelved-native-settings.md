---
title: "Shelved: native in-game settings"
---

# Shelved for 1.0: the native in-game settings work

::: info From the aowlspt repository — [`docs/SHELVED-NATIVE-SETTINGS.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/SHELVED-NATIVE-SETTINGS.md)
...
**Why the in-game settings work was switched off before 1.0, and exactly what is left to finish if anyone picks it up.**
...
The settings surface that DOES ship is the browser page from [`mods/uihub`](https://github.com/aoughwl/aowlspt/tree/main/mods/uihub)
...
traps, and re-deriving them costs hours. Then [`tools/acceptance.py`](https://github.com/aoughwl/aowlspt/blob/main/tools/acceptance.py), which
