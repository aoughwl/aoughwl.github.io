...
::: info From the aowlspt repository — [`docs/LOOT-CONFIG.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/LOOT-CONFIG.md)
...
**The file you edit is [`mods/tarkov/config.json`](https://github.com/aoughwl/aowlspt/blob/main/mods/tarkov/config.json)** (in the live install:
...
<code>GET http://127.0.0.1:&lt;control-port&gt;/aowlspt/tarkov/selfcheck</code> returns
