---
title: "Importing all maps into one Unity scene"
---

# Import all EFT maps into one Unity scene (click once)

::: info From the aowlspt repository — [`docs/UNITY_MAP_IMPORT.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/UNITY_MAP_IMPORT.md)
...
Companion to [the map rip](./map-rip-and-reimport), and the same caveat applies.
:::
...
Each map lives as a **folder** under <code>Assets/Content/Locations/&lt;Map&gt;/</code>, split into
...
map under <code>AowlWorld/&lt;Map&gt;</code>.
...
5. stops AssetRipper, locates the exported project
   ...
   into <code>&lt;project&gt;&#92;Assets&#92;Editor&#92;</code>** so the menu is present when you open it.
...
4. Then copy `tools\unity_import\Editor\AowlEftMapImporter.cs` into
   <code>&lt;exported project&gt;&#92;Assets&#92;Editor&#92;</code> yourself.
...
This opens **every** map, groups each under <code>AowlWorld/&lt;Map&gt;</code>, auto-positions the
...
- [`tools/unity_import/rip_maps.ps1`](https://github.com/aoughwl/aowlspt/blob/main/tools/unity_import/rip_maps.ps1) -- the AssetRipper driver (headless HTTP, or
  `-Interactive`).
- [`tools/unity_import/Editor/AowlEftMapImporter.cs`](https://github.com/aoughwl/aowlspt/blob/main/tools/unity_import/Editor/AowlEftMapImporter.cs) -- the Editor menu; copied
