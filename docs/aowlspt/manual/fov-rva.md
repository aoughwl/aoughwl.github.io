---
title: "FOV \u2014 static RVAs"
---

# FOV mod — static RVAs (byte-verified, offline)

::: info From the aowlspt repository — [`docs/FOV_RVA.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/FOV_RVA.md)
...
Resolved offline with [`tools/il2cpp_resolve.py`](https://github.com/aoughwl/aowlspt/blob/main/tools/il2cpp_resolve.py) against
...
* The mod ABI exposes only **by-name** patching — `patch`/`patchTyped`
  ([`aowl/src/aowlspt/abi.nim`](https://github.com/aoughwl/aowlspt/blob/main/aowl/src/aowlspt/abi.nim)) take `target: AowlSlice` (a string like
...
<code>Type::Method@0xRVA/&lt;shape&gt;&#91;!&lt;hex prologue&gt;&#93;</code>. [`mods/ammoloading`](https://github.com/aoughwl/aowlspt/tree/main/mods/ammoloading) has been
shipping four such specs, and [`mods/fov`](https://github.com/aoughwl/aowlspt/tree/main/mods/fov) has been arming all three effects
...
[`host/Aowlspt.Host.Il2Cpp/patchrva.nim`](https://github.com/aoughwl/aowlspt/blob/main/host/Aowlspt.Host.Il2Cpp/patchrva.nim) gates all three, refuses out loud
...
`hookRva`/`hookReturnRva` ([`aowl/src/aowlspt/abi.nim`](https://github.com/aoughwl/aowlspt/blob/main/aowl/src/aowlspt/abi.nim), `game.nim`).
