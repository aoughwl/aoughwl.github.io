---
title: "Native Unity UI from a mod"
---

# Native Unity UI from a mod — the `nu*` toolkit

::: info From the aowlspt repository — [`docs/NATIVE_UI.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/NATIVE_UI.md)
...
* a `UnityEngine.UI.Image` built from scratch — `IMAGEPROOF VERDICT = PASS`
  (2026-08-30): `object_new` + ctor + <code>AddComponent&lt;Image&gt;</code>, an auto-added
...
It covers [`host/Aowlspt.Host.Il2Cpp/nuikit.nim`](https://github.com/aoughwl/aowlspt/blob/main/host/Aowlspt.Host.Il2Cpp/nuikit.nim).
...
A handle is <code>(generation &lt;&lt; 16) &#124; (index + 1)</code> in a fixed 64-entry table.
