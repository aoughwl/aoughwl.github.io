---
title: "The main-menu UI map"
---

# Tarkov main-menu UI map

::: info From the aowlspt repository — [`docs/UI-MAP.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/UI-MAP.md)
...
Generated by [`tools/gen_uimap.py`](https://github.com/aoughwl/aowlspt/blob/main/tools/gen_uimap.py) from `GameAssembly.dll` + the decrypted global-metadata. This is what the BINARY DECLARES; nothing here is verified against a running client, so a pointer walk still has to be proven live.
...
A method with RVA `-` and sharedness `no-code` is a GENERIC DEFINITION: its bodies are one per INSTANTIATION, in `genericMethodPointers`. `-` is not 'no such method' and it is certainly not address 0 -- ask <code>il2cpp&#95;resolve.py GAMEASM METADEC genericmethods &lt;Type&gt;::&lt;Name&gt;</code>.
...
| 0xc07800 | **shared x3** | <code>void &lt;CreateBindings&gt;b&#95;&#95;1&#95;0(List&lt;AxisGroup&gt; x)</code> |
| 0xc07800 | **shared x3** | <code>void &lt;CreateBindings&gt;b&#95;&#95;1&#95;1(List&lt;KeyGroup&gt; x)</code> |
| 0xc07800 | **shared x3** | <code>void &lt;CreateBindings&gt;b&#95;&#95;1&#95;2(float x)</code> |
...
| `0x58` | <code>&lt;SystemMessageLocale&gt;k&#95;&#95;BackingField</code> | string |
...
| 0xc08650 | unique | <code>bool MergeAxisWithDefault(List&lt;AxisGroup&gt; defaultBindings)</code> |
| 0xc08880 | unique | <code>AxisGroup GetAxisGroup(List&lt;AxisGroup&gt; axisBindings, EAxis axisName)</code> |
| 0xc089e0 | unique | <code>List&lt;AxisGroup&gt; AxisBindingsPreProcessor(List&lt;AxisGroup&gt; axisBindings)</code> |
...
| 0xc095d0 | unique | <code>bool MergeKeysWithDefault(List&lt;KeyGroup&gt; defaultBindings)</code> |
| 0xc09a40 | unique | <code>KeyGroup GetKeyGroup(IReadOnlyList&lt;KeyGroup&gt; keyBindings, EGameKey keyName)</code> |
...
| 0xc0a470 | unique | <code>List&lt;KeyGroup&gt; KeyBindingsPreProcessor(List&lt;KeyGroup&gt; keyBindings)</code> |
| 0xc0a650 | unique | `ControlSettingsGroup Clone()` |
| 0xc0a6e0 | unique | `void .cctor()` |
| 0xc0ac40 | unique | <code>bool &lt;CreateMergedControl&gt;g&#95;&#95;TryMergeVariants&#124;31&#95;0(KeyGroup group1, KeyGroup group2, ValueTuple&lt;int,int&gt; index, InputSource result)</code> |
| 0xc0aea0 | unique | <code>void &lt;CreateMergedControl&gt;g&#95;&#95;PushInputSourceValues&#124;31&#95;1(InputSource source, InputSource target)</code> |

### `EFT.Settings.Control.ControlSettingsVersions`

| offset | field | type |
|---|---|---|
| `0x0` | <code>&lt;Serializer&gt;k&#95;&#95;BackingField</code> | IJsonSerializer *(static)* |
...
| offset | field | type |
|---|---|---|
| `0x10` | <code>&lt;X&gt;k&#95;&#95;BackingField</code> | int |
| `0x14` | <code>&lt;Y&gt;k&#95;&#95;BackingField</code> | int |
...
| 0xbeb640 | unique | <code>ReadOnlyCollection&lt;AspectRatio&gt; get&#95;SortedAspectRatios()</code> |
| 0xbeb970 | unique | `AspectRatio SuitableAspectRatio(EftResolution resolution)` |
| 0xbeba50 | unique | <code>HashSet&lt;AspectRatio&gt; GetAspectRatios(EftResolution&#91;&#93; resolutions)</code> |
...
| 0xbec950 | unique | <code>IReadOnlyList&lt;DisplayInfo&gt; GetDisplaysLayout()</code> |
| 0xbeca90 | unique | <code>bool ValidateDisplaysLayout(IReadOnlyList&lt;DisplayInfo&gt; layout)</code> |
...
| 0xbedf60 | unique | <code>ReadOnlyCollection&lt;EftResolution&gt; GetSortedResolutions()</code> |
| 0xbee270 | unique | <code>HashSet&lt;EftResolution&gt; GetResolutions()</code> |
...
| 0xbee7b0 | unique | <code>void SelectExclusiveFullscreenModeResolutions(HashSet&lt;EftResolution&gt; resolutions, bool landscape)</code> |
| 0xbee970 | unique | <code>void SelectFullscreenModeResolutions(HashSet&lt;EftResolution&gt; resolutions, bool landscape)</code> |
| 0xbeeb90 | unique | <code>void SelectWindowModeResolutions(HashSet&lt;EftResolution&gt; resolutions, bool landscape)</code> |
| 0xbeeec0 | unique | <code>void AddWindowModeWorkAreaResolution(HashSet&lt;EftResolution&gt; resolutions, RectInt workArea)</code> |
...
| 0xbf18d0 | unique | <code>int GetIndexFromQuality(Nullable&lt;int&gt; quality)</code> |
| 0xbf1980 | unique | `int GetQualityFromIndex(int index)` |
| 0xbf19e0 | unique | <code>GraphicsPreset GetPreset(Nullable&lt;int&gt; quality)</code> |
...
| 0xbf31a0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;3&#95;0(EftDisplaySettings displaySettings)</code> |
| 0xbf31e0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;3&#95;1(ESamplingMode x)</code> |
| 0xbf32b0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;3&#95;2(EAntialiasingMode x)</code> |
| 0xbf34b0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;3&#95;3(EDLSSMode x)</code> |
| 0xbf36b0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;3&#95;4(EFSR2Mode x)</code> |
| 0xbf38b0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;3&#95;5(EFSR3Mode x)</code> |
| 0xbf3ab0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;3&#95;6(EFSR2Mode x)</code> |
| 0xbf3ad0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;3&#95;7(EFSR3Mode x)</code> |
| 0xbf3af0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;3&#95;8(EDLSSPreset x)</code> |
...
| `0x1c` | <code>&lt;SDModeLevel&gt;k&#95;&#95;BackingField</code> | int *(static)* |
| `0x20` | <code>&lt;ApplySDModeOnRuntime&gt;k&#95;&#95;BackingField</code> | bool *(static)* |
...
| 0xbf4370 | unique | <code>Task&lt;EftDisplaySettings&gt; ApplyDisplaySettings(EftDisplaySettings settings)</code> |
| 0xbf4520 | unique | <code>Task&lt;EftDisplaySettings&gt; SwitchDisplay(EftDisplaySettings settings)</code> |
| 0xbf46e0 | unique | <code>Task&lt;EftDisplaySettings&gt; SwitchDisplay(EftDisplaySettings settings, DisplayInfo displayInfo)</code> |
| 0xbf4c20 | unique | <code>Task&lt;EftDisplaySettings&gt; SwitchDisplayWindowMode(EftDisplaySettings settings, DisplayInfo displayInfo)</code> |
| 0xbf4e00 | unique | <code>Task&lt;EftDisplaySettings&gt; SwitchDisplayExclusiveFullScreenMode(EftDisplaySettings settings, DisplayInfo displayInfo)</code> |
| 0xbf4fe0 | unique | <code>Task&lt;EftDisplaySettings&gt; SwitchDisplayFullScreenMode(EftDisplaySettings settings, DisplayInfo displayInfo)</code> |
| 0xbf51c0 | unique | <code>Task&lt;EftDisplaySettings&gt; ChangeMode(EftDisplaySettings settings)</code> |
| 0xbf5300 | unique | <code>Task&lt;EftDisplaySettings&gt; ChangeResolution(EftDisplaySettings settings)</code> |
| 0xbf5440 | unique | `void RefreshSdMode(bool isActive)` |
| 0xbf54e0 | unique | <code>void ApplyQualityPreset(Nullable&lt;int&gt; quality)</code> |
...
| 0xbf5ce0 | unique | <code>void RefreshStreamingMemoryBudget(Vector4 budgets, Nullable&lt;int&gt; quality)</code> |
...
| 0xbf8330 | unique | <code>void &lt;CreateBindingsAsync&gt;b&#95;&#95;28&#95;0(int x)</code> |
...
| `0x28` | <code>&lt;InApplyDisplaySettingsProcess&gt;k&#95;&#95;BackingField</code> | bool |
...
| `0x140` | <code>&lt;SystemMessageLocale&gt;k&#95;&#95;BackingField</code> | string |
...
| 0xbff660 | unique | <code>Task&lt;EftDisplaySettings&gt; ApplyDisplaySettings(EftDisplaySettings displaySettings)</code> |
| 0xbff8c0 | unique | <code>Task&lt;EftDisplaySettings&gt; ApplyDisplaySettingsAsync(EftDisplaySettings displaySettings)</code> |
...
| 0xbe2c10 | unique | <code>void AddFloatSettingToConsole(GameSetting&lt;float&gt; setting, string description, string additionalKey)</code> |
| 0xbe2c90 | unique | <code>void AddBoolSettingToConsole(GameSetting&lt;bool&gt; setting, string description, string additionalKey)</code> |
| - | no-code | <code>void AddEnumSettingToConsole(GameSetting&lt;mvar&gt; setting, string description, string additionalKey)</code> |
| - | no-code | <code>void AddSettingToConsole(GameSetting&lt;mvar&gt; setting, string description, string additionalKey)</code> |
| 0xbe2d10 | unique | `void PrintRegisteredCommands()` |
| 0xbe2e80 | unique | <code>Task&lt;bool&gt; MergeControlWithDefault(SettingsWithProvider&lt;ControlSettingsGroup&gt; loadedSettings)</code> |
| 0xbe3130 | unique | <code>Task&lt;SettingsManager&gt; InstantiateSingleton()</code> |
...
| 0xbe6170 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;17&#95;0(int x)</code> |
| 0xbe61c0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;17&#95;1(int x)</code> |
| 0xbe6210 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;17&#95;2(int x)</code> |
| 0xbe6260 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;17&#95;3(int x)</code> |
| 0xbe62b0 | unique | <code>void &lt;CreateBindings&gt;b&#95;&#95;17&#95;4(int x)</code> |
...
| 0xbe7670 | unique | <code>ReadOnlyCollection&lt;string&gt; GetMicrophones()</code> |
...
| `0x18` | <code>&lt;PressType&gt;k&#95;&#95;BackingField</code> | Nullable&lt;EPressType> |
| `0x20` | <code>&lt;ExtraVariants&gt;k&#95;&#95;BackingField</code> | InputSource[] |
| `0x28` | `EnableForSourcePressType` | EPressType[] |
| `0x30` | <code>&lt;IgnorePool&gt;k&#95;&#95;BackingField</code> | bool |

7 method(s) declared.

| RVA | sharedness | signature |
|---|---|---|
| 0x6898f0 | **shared x1759** | <code>Nullable&lt;EPressType&gt; get&#95;PressType()</code> |
...
| RVA | sharedness | signature |
|---|---|---|
| - | no-code | <code>void .ctor(GameSetting&lt;var&gt; gameSetting, Func&lt;var,Task&lt;var&gt;&gt; setter)</code> |
| - | no-code | <code>Action Diz.Binding.IBindable&lt;T&gt;.Bind(Action&lt;var&gt; handler)</code> |
| - | no-code | <code>Action Diz.Binding.IBindable&lt;T&gt;.Subscribe(Action&lt;var&gt; handler)</code> |
| - | no-code | <code>Action Diz.Binding.IBindable&lt;T&gt;.BindWithoutValue(ICheckChanges handler)</code> |
| - | no-code | <code>var Diz.Binding.IBindable&lt;T&gt;.get&#95;Value()</code> |
| - | no-code | <code>Task&lt;var&gt; Bsg.GameSettings.IAccessor&lt;T&gt;.Set(var t)</code> |
| - | no-code | <code>Task&lt;var&gt; Set(var t)</code> |
...
| `GENERIC` | <code>&lt;IsFirstBind&gt;k&#95;&#95;BackingField</code> | bool |
...
| - | no-code | <code>void Bind(GameSetting&lt;mvar&gt; gameSetting, Action&lt;mvar&gt; handler)</code> |
| - | no-code | <code>void Subscribe(GameSetting&lt;mvar&gt; gameSetting, Action&lt;mvar&gt; handler)</code> |
...
| RVA | sharedness | signature |
|---|---|---|
| - | no-code | <code>void .ctor(string key, var defaultValue, Func&lt;var,Task&lt;var&gt;&gt; asyncPreProcessor)</code> |
| - | no-code | <code>void .ctor(string key, var defaultValue, Func&lt;var,var&gt; preProcessor)</code> |
| - | no-code | <code>bool HasSameValue(GameSetting&lt;var&gt; other)</code> |
...
| RVA | sharedness | signature |
|---|---|---|
| - | no-code | <code>void .ctor(GameSetting&lt;var&gt; baseSetting, Func&lt;var,var&gt; propertyGetter, Func&lt;var,Task&gt; propertySetter)</code> |
| - | no-code | `var GetValue()` |
| - | no-code | `Task SetValue(var value)` |
| - | no-code | <code>void TakeValueFrom(GameSetting&lt;var&gt; other)</code> |
| - | no-code | <code>Action Bind(Action&lt;var&gt; handler)</code> |
| - | no-code | <code>Action Subscribe(Action&lt;var&gt; handler)</code> |
| - | no-code | `Action BindWithoutValue(ICheckChanges handler)` |
| - | no-code | `void ResetToDefault()` |
| - | no-code | `void ForceApply()` |
| - | no-code | <code>bool HasSameValue(GameSetting&lt;var&gt; other)</code> |
| - | no-code | <code>Action&lt;var&gt; GetSubscriber(Action&lt;var&gt; handler)</code> |
...
| `GENERIC` | <code>&lt;Key&gt;k&#95;&#95;BackingField</code> | string |
| `GENERIC` | <code>&lt;IsAvailableToEdit&gt;k&#95;&#95;BackingField</code> | bool |
...
| - | no-code | <code>void .ctor(string key, Func&lt;var,var&gt; preProcessor)</code> |
| - | no-code | <code>void .ctor(string key, Func&lt;var,Task&lt;var&gt;&gt; asyncPreProcessor)</code> |
| - | no-code | <code>Task&lt;var&gt; PreProcessValue(var value)</code> |
| - | no-code | <code>bool HasSameValue(GameSetting&lt;var&gt; other)</code> |
| - | no-code | <code>void TakeValueFrom(GameSetting&lt;var&gt; other)</code> |
| - | no-code | <code>Action Bind(Action&lt;var&gt; handler)</code> |
| - | no-code | <code>Action Subscribe(Action&lt;var&gt; handler)</code> |
...
| - | no-code | <code>var op&#95;Implicit(GameSetting&lt;var&gt; setting)</code> |
| - | no-code | `void .cctor()` |
...
| RVA | sharedness | signature |
|---|---|---|
| - | no-code | <code>IReadOnlyList&lt;SettingsPreset&lt;var&gt;&gt; get&#95;Presets()</code> |
| - | no-code | `Task RefreshPresetList()` |
| - | no-code | <code>Task&lt;SettingsPreset&lt;var&gt;&gt; CreateNewPreset(string name, var settingsGroup)</code> |
| - | no-code | <code>Task RemovePreset(SettingsPreset&lt;var&gt; preset)</code> |
...
| RVA | sharedness | signature |
|---|---|---|
| - | no-code | <code>Task&lt;mvar&gt; Load(mvar settingsGroup)</code> |
...
| - | no-code | <code>Task&lt;mvar&gt; Load(mvar settingsGroup)</code> |
| - | no-code | `Task Save(mvar settingsGroup)` |
| - | no-code | <code>Task&lt;JObject&gt; LoadJson()</code> |
| - | no-code | `Task SaveJson(JObject json)` |
| 0x2592be0 | unique | <code>Task&lt;JObject&gt; GetFromFallback()</code> |
...
| 0x2593cd0 | unique | <code>Task&lt;JObject&gt; LoadJson()</code> |
...
| 0x2593f20 | unique | <code>Task&lt;JObject&gt; LoadJson()</code> |
...
| RVA | sharedness | signature |
|---|---|---|
| - | no-code | <code>void ConvertIndexToObject(JObject data, string name, IReadOnlyList&lt;mvar&gt; variants)</code> |
| - | no-code | <code>void ConvertIndexToValue(JObject data, string name, IReadOnlyList&lt;mvar&gt; variants)</code> |
...
| 0x2595010 | unique | <code>Task&lt;JObject&gt; LoadJson()</code> |
...
| - | no-code | <code>Task&lt;SettingsPreset&lt;var&gt;&gt; CreateNewPreset(string name, var settingsGroup)</code> |
| - | no-code | <code>Task RemovePreset(SettingsPreset&lt;var&gt; preset)</code> |
| - | no-code | <code>SettingsPreset&lt;var&gt; CreatePreset(string path)</code> |
| - | no-code | <code>SettingsPreset&lt;var&gt; CreatePreset(string path, string name)</code> |
...
| RVA | sharedness | signature |
|---|---|---|
| - | no-code | <code>void .ctor(string key, CopyItem&lt;var&gt; copyItem, EqualityCheck&lt;var&gt; equalityCheck, Func&lt;List&lt;var&gt;,List&lt;var&gt;&gt; preProcessor)</code> |
| - | no-code | <code>List&lt;var&gt; GetValue()</code> |
| - | no-code | <code>Task SetValue(List&lt;var&gt; value)</code> |
| - | no-code | <code>bool HasSameValue(GameSetting&lt;List&lt;var&gt;&gt; other)</code> |
| - | no-code | <code>void TakeValueFrom(GameSetting&lt;List&lt;var&gt;&gt; other)</code> |
| - | no-code | <code>Action Bind(Action&lt;List&lt;var&gt;&gt; handler)</code> |
| - | no-code | <code>Action Subscribe(Action&lt;List&lt;var&gt;&gt; handler)</code> |
| - | no-code | `Action BindWithoutValue(ICheckChanges handler)` |
| - | no-code | `void ResetToDefault()` |
| - | no-code | `void ForceApply()` |
| - | no-code | `var[] ToArray()` |
...
| RVA | sharedness | signature |
|---|---|---|
| - | no-code | <code>IList&lt;IGameSetting&gt; GetSettingsList()</code> |
...
| - | no-code | <code>GameSetting&lt;mvar&gt; Register(GameSetting&lt;mvar&gt; setting)</code> |
| - | no-code | <code>GameSetting&lt;mvar&gt; RegisterEquatable(string key, mvar defaultValue, Func&lt;mvar,mvar&gt; preProcessor)</code> |
| - | no-code | <code>GameSetting&lt;mvar&gt; RegisterEquatable(string key, mvar defaultValue, Func&lt;mvar,Task&lt;mvar&gt;&gt; preProcessor)</code> |
| - | no-code | <code>GameSetting&lt;mvar&gt; RegisterState(string key, mvar defaultValue, Func&lt;mvar,mvar&gt; preProcessor)</code> |
| - | no-code | <code>GameSetting&lt;mvar&gt; RegisterState(string key, mvar defaultValue, Func&lt;mvar,Task&lt;mvar&gt;&gt; preProcessor)</code> |
| - | no-code | <code>ListGameSetting&lt;mvar&gt; RegisterList(string key, CopyItem&lt;mvar&gt; copyItem, EqualityCheck&lt;mvar&gt; equalityCheck, Func&lt;List&lt;mvar&gt;,List&lt;mvar&gt;&gt; preProcessor)</code> |
...
| `GENERIC` | <code>&lt;Name&gt;k&#95;&#95;BackingField</code> | string |
...
| - | no-code | <code>Task&lt;var&gt; Load(var settingsGroup)</code> |
...
| `0x80` | <code>&lt;AxisGroup&gt;k&#95;&#95;BackingField</code> | AxisGroup |
| `0x88` | <code>&lt;Positive&gt;k&#95;&#95;BackingField</code> | bool |
...
| 0x16f7970 | unique | <code>void &lt;Awake&gt;b&#95;&#95;20&#95;0()</code> |
| 0x16f79a0 | unique | <code>void &lt;Awake&gt;b&#95;&#95;20&#95;1()</code> |
...
| `0x108` | <code>&lt;KeyGroup&gt;k&#95;&#95;BackingField</code> | KeyGroup |
...
| 0x16f9340 | unique | <code>void Show(KeyGroup keyGroup, Dictionary&lt;string,EPressType&gt; pressTypes, bool interactable)</code> |
| 0x16f9b60 | unique | `void .ctor()` |
| 0x16f9b80 | **shared x3** | <code>void &lt;ListenForKey&gt;b&#95;&#95;28&#95;3()</code> |
| 0x16f9bb0 | **shared x3** | <code>void &lt;ListenForKey&gt;b&#95;&#95;28&#95;4()</code> |
| 0x16f9b80 | **shared x3** | <code>void &lt;ListenForKey&gt;b&#95;&#95;28&#95;1()</code> |
| 0x16f9bb0 | **shared x3** | <code>void &lt;ListenForKey&gt;b&#95;&#95;28&#95;2()</code> |
| 0x16f9b80 | **shared x3** | <code>void &lt;Show&gt;b&#95;&#95;37&#95;0()</code> |
| 0x16f9bb0 | **shared x3** | <code>void &lt;Show&gt;b&#95;&#95;37&#95;1()</code> |
...
| `0x170` | <code>&lt;CanPressEscape&gt;k&#95;&#95;BackingField</code> | bool |
...
| 0x1701f30 | unique | <code>void &lt;Awake&gt;b&#95;&#95;32&#95;0(bool isOn)</code> |
| 0x1701fa0 | unique | <code>bool &lt;ShowBindings&gt;b&#95;&#95;43&#95;0(AxisGroup x)</code> |
| 0x1702000 | unique | <code>bool &lt;ShowBindings&gt;b&#95;&#95;43&#95;6(KeyGroup x)</code> |
| 0x1702060 | **shared x2** | <code>void &lt;ShowBindings&gt;b&#95;&#95;43&#95;7()</code> |
| 0x1702060 | **shared x2** | <code>void &lt;CreateAxisBinding&gt;b&#95;&#95;47&#95;0()</code> |
| 0x1702070 | unique | <code>void &lt;InitGestures&gt;b&#95;&#95;52&#95;0(ValueTuple&lt;int,bool&gt; x)</code> |
...
| - | no-code | <code>SettingDropDown ShowCommonDropDown(GameSetting&lt;mvar&gt; setting, RectTransform root, bool twoWays, Func&lt;int,bool&gt; validator, Action customUpdater, string localizationFormat)</code> |
...
| 0x17084b0 | unique | <code>void &lt;Awake&gt;b&#95;&#95;20&#95;0(string x)</code> |
| 0x1708510 | unique | <code>void &lt;Awake&gt;b&#95;&#95;20&#95;1(string x)</code> |
| 0x1708520 | unique | <code>void &lt;Awake&gt;b&#95;&#95;20&#95;2(string x)</code> |
| 0x1708580 | unique | <code>void &lt;Show&gt;b&#95;&#95;22&#95;0(bool x)</code> |
| 0x1708590 | unique | <code>string &lt;ShowEnvironment&gt;g&#95;&#95;StringConverter&#124;26&#95;4(EEnvironmentUIType value)</code> |
| 0x1708640 | unique | <code>void &lt;ShowClearWishlistButton&gt;g&#95;&#95;ClearWishlist&#124;29&#95;0()</code> |
| 0x1708970 | unique | <code>void &lt;ChangeNickname&gt;b&#95;&#95;42&#95;0(Result&lt;ChangeNicknameStatus&gt; changeNicknameResult)</code> |
...
| 0x1715230 | unique | <code>bool &lt;CreateBlockers&gt;b&#95;&#95;33&#95;2(EDLSSMode &#95;)</code> |
| 0x1715260 | unique | <code>bool &lt;CreateBlockers&gt;b&#95;&#95;33&#95;3(EDLSSMode &#95;)</code> |
| 0x1715290 | unique | <code>bool &lt;CreateBlockers&gt;b&#95;&#95;33&#95;4(EFSR2Mode &#95;)</code> |
| 0x17152c0 | unique | <code>bool &lt;CreateBlockers&gt;b&#95;&#95;33&#95;5(EFSR3Mode &#95;)</code> |
| 0x17152f0 | **shared x2** | <code>bool &lt;CreateBlockers&gt;b&#95;&#95;33&#95;8()</code> |
| 0x1715300 | unique | <code>string &lt;ShowFullScreen&gt;g&#95;&#95;StringConverter&#124;37&#95;3(FullScreenMode mode)</code> |
| 0x1715410 | unique | <code>string &lt;ShowDisplays&gt;g&#95;&#95;StringConverter&#124;38&#95;4(byte value)</code> |
| 0x17154b0 | unique | <code>void &lt;ShowOverallQuality&gt;g&#95;&#95;ApplyQualitySettings&#124;40&#95;0(Nullable&lt;int&gt; quality)</code> |
| 0x1715580 | unique | <code>string &lt;ShowOverallQuality&gt;g&#95;&#95;StringConverter&#124;40&#95;1(string input)</code> |
| 0x1715650 | unique | <code>void &lt;ShowVolumeLight&gt;b&#95;&#95;47&#95;0(ESSRMode &#95;)</code> |
| 0x1715660 | **shared x2** | <code>void &lt;ShowVolumeLight&gt;b&#95;&#95;47&#95;1(EFSR2Mode &#95;)</code> |
| 0x1715660 | **shared x2** | <code>void &lt;ShowVolumeLight&gt;b&#95;&#95;47&#95;2(EFSR3Mode &#95;)</code> |
| 0x1715670 | unique | <code>bool &lt;ShowVolumeLight&gt;g&#95;&#95;VolumetricLightQualityValidator&#124;47&#95;3(int modeIndex)</code> |
| 0x1715750 | unique | <code>void &lt;ShowVolumeLight&gt;g&#95;&#95;ShowVolumetricLightChangedMessage&#124;47&#95;4()</code> |
| 0x1715950 | unique | <code>void &lt;ShowVolumeLight&gt;g&#95;&#95;FixVolumetricQuality&#124;47&#95;5()</code> |
| 0x1715a80 | unique | <code>bool &lt;ShowNvidiaDlss&gt;g&#95;&#95;DLSSModeValidator&#124;48&#95;0(int modeIndex)</code> |
| 0x1715b80 | unique | <code>bool &lt;ShowDlssPreset&gt;g&#95;&#95;DLSSPresetValidator&#124;49&#95;0(int modeIndex)</code> |
| 0x1715dd0 | **shared x2** | <code>void &lt;ShowAmdFsr22&gt;b&#95;&#95;50&#95;0(EftDisplaySettings &#95;)</code> |
| 0x1715e00 | unique | <code>bool &lt;ShowAmdFsr22&gt;g&#95;&#95;FSR2ModeValidator&#124;50&#95;1(int modeIndex)</code> |
| 0x1715dd0 | **shared x2** | <code>void &lt;ShowAmdFsr3&gt;b&#95;&#95;51&#95;0(EftDisplaySettings &#95;)</code> |
| 0x1715ee0 | unique | <code>bool &lt;ShowAmdFsr3&gt;g&#95;&#95;FSR3ModeValidator&#124;51&#95;1(int modeIndex)</code> |
| 0x1715fc0 | unique | <code>void &lt;ShowHqColor&gt;b&#95;&#95;64&#95;0(bool &#95;)</code> |
| 0x1715fd0 | unique | <code>void &lt;ShowHqColor&gt;g&#95;&#95;ShowValueChangedMessage&#124;64&#95;1()</code> |
...
| - | no-code | <code>SettingDropDown BindToEnum(GameSetting&lt;mvar&gt; setting, bool twoWays, Func&lt;int,bool&gt; validator, Func&lt;mvar,string&gt; stringConverter)</code> |
| - | no-code | <code>SettingDropDown BindTo(GameSetting&lt;mvar&gt; setting, ReadOnlyCollection&lt;mvar&gt; variants, Func&lt;mvar,string&gt; stringConverter, bool twoWays, Func&lt;int,bool&gt; validator)</code> |
| 0x16fb390 | unique | `void SetValueText(string value)` |
| 0x16fb3c0 | unique | `SettingDropDown SetSpriteAsset(TMP_SpriteAsset asset)` |
| - | no-code | <code>Action BindDropDownToSetting(DropDownBox dropdown, GameSetting&lt;mvar&gt; setting, ReadOnlyCollection&lt;mvar&gt; variants, Func&lt;mvar,string&gt; stringConverter, Func&lt;int,bool&gt; validator)</code> |
| - | no-code | `void UpdateDropDownEnumValue(mvar value)` |
| - | no-code | <code>bool UpdateDropDownValue(DropDownBox dropdown, mvar value, ReadOnlyCollection&lt;mvar&gt; variants)</code> |
...
|---|---|---|
| 0x66e6c0 | **shared x60** | `Component get_TargetComponent()` |
| - | no-code | <code>SettingSelectSlider BindIndexTo(GameSetting&lt;int&gt; setting, ReadOnlyCollection&lt;mvar&gt; variants, Func&lt;mvar,string&gt; stringConverter, bool twoWays, Func&lt;int,int&gt; indexToSetting, Func&lt;int,int&gt; settingToIndex)</code> |
| - | no-code | <code>SettingSelectSlider BindIndexTo(GameSetting&lt;mvar&gt; setting, ReadOnlyCollection&lt;mvar&gt; variants, Func&lt;mvar,string&gt; stringConverter, bool twoWays, Func&lt;int,mvar&gt; indexToSetting, Func&lt;mvar,int&gt; settingToIndex)</code> |
| - | no-code | <code>SettingSelectSlider BindIndexTo(GameSetting&lt;Nullable&lt;int&gt;&gt; setting, ReadOnlyCollection&lt;mvar&gt; variants, Func&lt;mvar,string&gt; stringConverter, bool twoWays, Func&lt;int,int&gt; indexToSetting, Func&lt;Nullable&lt;int&gt;,int&gt; settingToIndex)</code> |
| 0x16fbbe0 | unique | `void SetValueText(string value)` |
| - | no-code | <code>bool UpdateSliderValue(SelectSlider slider, mvar value, ReadOnlyCollection&lt;mvar&gt; variants)</code> |
| 0xcfd7d0 | **shared x26** | `void .ctor()` |
...
| 0x16fc080 | unique | <code>void SetMessageText(Func&lt;string&gt; textGetter)</code> |
| 0x629540 | **shared x676** | `void .ctor()` |
...
| 0x1721900 | unique | <code>void &lt;Awake&gt;b&#95;&#95;26&#95;0()</code> |
| 0x1721950 | unique | <code>void &lt;DisplayRevertMessage&gt;b&#95;&#95;41&#95;0()</code> |
...
| RVA | sharedness | signature |
|---|---|---|
| 0x171ba60 | unique | <code>void add&#95;OnLoadingInProgress(Action&lt;bool&gt; value)</code> |
| 0x171bb80 | unique | <code>void remove&#95;OnLoadingInProgress(Action&lt;bool&gt; value)</code> |
...
| 0x16fc900 | unique | <code>IEnumerator &lt;Display&gt;g&#95;&#95;RebuildLayoutNextFrame&#124;13&#95;0()</code> |
...
| 0x171cc70 | unique | <code>void ShowDeviceDropDown(GameSetting&lt;string&gt; setting, Transform container, ReadOnlyCollection&lt;string&gt; devices)</code> |
| 0x171cdb0 | unique | <code>void BindDeviceDropDown(GameSetting&lt;string&gt; setting, ReadOnlyCollection&lt;string&gt; devices)</code> |
| 0x171cf60 | unique | <code>void ShowDenoiseAmountDropDown(GameSetting&lt;NoiseSuppressionLevels&gt; setting, Transform container)</code> |
| 0x171d0f0 | unique | <code>void ShowSettingSelectSlider(GameSetting&lt;int&gt; setting)</code> |
| 0x171d2e0 | unique | <code>void ShowSettingToggle(GameSetting&lt;bool&gt; setting)</code> |
...
| 0x171e670 | unique | <code>void &lt;ShowDeviceDropDown&gt;b&#95;&#95;30&#95;0()</code> |
| 0x171e6a0 | unique | <code>void &lt;ShowVoipSection&gt;b&#95;&#95;36&#95;0()</code> |
...
| RVA | sharedness | signature |
|---|---|---|
| 0x65ed10 | **shared x107** | <code>IBindableEvent&lt;bool&gt; get&#95;OnStateChange()</code> |
| 0x1433490 | unique | <code>Dictionary&lt;EToggleInternalState,List&lt;GameObject&gt;&gt; get&#95;States()</code> |
