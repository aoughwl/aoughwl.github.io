---
title: "The auto-raid flows"
---

# AUTORAID-MAP — the three flows, with the evidence behind each claim

::: info From the aowlspt repository — [`docs/AUTORAID-MAP.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/AUTORAID-MAP.md)
...
[`mods/autoraid`](https://github.com/aoughwl/aowlspt/tree/main/mods/autoraid) (`aowl.autoraid`), written 2026-09-04. One DLL,
...
A port of [`host/Aowlspt.Host.Il2Cpp/autoraid.nim`](https://github.com/aoughwl/aowlspt/blob/main/host/Aowlspt.Host.Il2Cpp/autoraid.nim). The flow:
...
<code>NEXT-&gt;location</code>, post-SIDE and <code>NEXT-&gt;insurance</code> steps each timed out after 45 s
...
from [`tools/fldoff.py`](https://github.com/aoughwl/aowlspt/blob/main/tools/fldoff.py):
...
|---|---|---|
| `EFT.UI.AnimatedToggle` | `Toggle::Set(true, true)` @0x55BA450 | [`abi/aowlspt_premenu.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_premenu.h) row [1], UNIQUE, non-virtual |
| `EFT.UI.DefaultUIButton` | `_button`@0x108 → `TweenAnimatedButton::OnPointerClick(NULL)` @0x14359B0 | [`abi/aowlspt_premenu.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_premenu.h) row [2] |
| `UnityEngine.UI.Button` | `Button::Press()` @0x539A7A0 | [`abi/aowlspt_navui.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_navui.h) |
...
* **MEASURED (twice, independently)** — `Input::GetKeyDown` @0x531EB80 and its
  sixteen prologue bytes: once for [`abi/aowlspt_admin.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_admin.h) on 2026-08-31, once for
  [`mods/maps/sp/hud.nim`](https://github.com/aoughwl/aowlspt/blob/main/mods/maps/sp/hud.nim) on 2026-09-01. The agreement is the self-check.
