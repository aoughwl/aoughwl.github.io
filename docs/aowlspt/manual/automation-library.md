...
::: info From the aowlspt repository — [`docs/AUTOMATION_LIBRARY.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/AUTOMATION_LIBRARY.md)
...
::: warning Superseded by the API reference
This is the earlier design of the automation library, kept for the reasoning. The library as built is [The automation library — API reference](./automation-api).
:::
...
|---|---|---|
| the script API | [`tools/autoscript.nim`](https://github.com/aoughwl/aowlspt/blob/main/tools/autoscript.nim) | what a script imports |
| the gear minter | [`mods/tarkov/emu/loadout.nim`](https://github.com/aoughwl/aowlspt/blob/main/mods/tarkov/emu/loadout.nim) | mints + **reads back** the profile |
| the routes | [`mods/tarkov/tarkov.nim`](https://github.com/aoughwl/aowlspt/blob/main/mods/tarkov/tarkov.nim) | `/aowlspt/tarkov/autoscript/{loadout,verify}` |
| the driver verb | [`tools/aowl.nim`](https://github.com/aoughwl/aowlspt/blob/main/tools/aowl.nim) | `aowl script PATH.nim` |
| worked example | [`scripts/woods_pmc_m4.nim`](https://github.com/aoughwl/aowlspt/blob/main/scripts/woods_pmc_m4.nim) | the full raid case |
| the library's own acceptance | [`scripts/gear_must_fail.nim`](https://github.com/aoughwl/aowlspt/blob/main/scripts/gear_must_fail.nim) | must FAIL, and exits 0 when it does |

[`mods/tarkov`](https://github.com/aoughwl/aowlspt/tree/main/mods/tarkov) **is** the SPT emulator and owns the profile, so the minting lives
...
A PASS and a FAIL from one code path is the whole claim. [`scripts/gear_must_fail.nim`](https://github.com/aoughwl/aowlspt/blob/main/scripts/gear_must_fail.nim)
...
* **`enterRaid` shells out to [`tools/enterraid.py`](https://github.com/aoughwl/aowlspt/blob/main/tools/enterraid.py)**, so a script must be run
...
<code>aowlspt/store/aowl.tarkov/profile.&lt;id&gt;</code>.
...
[`tools/deploy.json`](https://github.com/aoughwl/aowlspt/blob/main/tools/deploy.json), so a rebuild from the wrong base cannot silently drop this
feature. Verify with:
