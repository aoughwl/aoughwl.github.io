---
title: "The client boot flow"
---

# The post-1.0 Tarkov client boot flow — complete offline map

::: info From the aowlspt repository — [`docs/BOOT-FLOW-MAP.md`](https://github.com/aoughwl/aowlspt/blob/main/docs/BOOT-FLOW-MAP.md)
...
abbreviated below as <code>R &lt;verb&gt;</code>. Verbs used: `find`, `fields`, `member`,
...
<code>R shared &lt;that RVA&gt;</code> answers `unknown`. That is a refusal, not "unshared".
...
reports; the body lives in a nested <code>&lt;Name&gt;d&#95;&#95;NN::MoveNext</code>. MEASURED — the
`d__NN` types are separate metadata types (<code>R find &lt;Name&gt;</code> finds them):

| Method | kickoff RVA | state machine | `MoveNext` RVA |
|---|---|---|---|
| `TarkovApplication::StartTask` | `0x977880` | <code>&lt;StartTask&gt;d&#95;&#95;85</code> (7926) | `0x9def00` |
| `CommonClientApplication`1::StartTask` | `0x3cbe420` | `&lt;StartTask>d__17` (7744) | `0x2fe7d90` (generic body) |
| `ClientApplication`1::StartTask` | `0x3cab830` | <code>&lt;StartTask&gt;d&#95;&#95;14</code> (7727) | `0x2fe72d0` (generic body) |
| `TarkovApplication::RunInitialLobbyFlow` | `0x97b550` | <code>&lt;RunInitialLobbyFlow&gt;d&#95;&#95;121</code> (7914) | `0x9d7fb0` |
| `TarkovApplication::RunCharacterSelectionFlow` | `0x97c350` | <code>&lt;RunCharacterSelectionFlow&gt;d&#95;&#95;130</code> (7912) | `0x9d6bd0` |
| `TarkovApplication::ShowCharacterSelectionScreen` | `0x97c0e0` | <code>&lt;ShowCharacterSelectionScreen&gt;d&#95;&#95;129</code> (7919) | `0x9daa00` |
| `TarkovApplication::ExecuteCharacterSelection` | `0x97c5e0` | <code>&lt;ExecuteCharacterSelection&gt;d&#95;&#95;131</code> (7874) | `0x9b6e60` |
| `TarkovApplication::ShowProfileLoadingScreen` | `0x979a10` | <code>&lt;ShowProfileLoadingScreen&gt;d&#95;&#95;108</code> (7924) | `0x9dd570` |
| `TarkovApplication::MainMenuLoad` | `0x97a380` | <code>&lt;MainMenuLoad&gt;d&#95;&#95;113</code> (7893) | `0x9c7ac0` |
| `TarkovApplication::InitPreloaderUI` | `0x97a530` | <code>&lt;InitPreloaderUI&gt;d&#95;&#95;114</code> (7879) | `0x9ba3e0` |
| `TarkovApplication::MainMenu` | `0x983130` | <code>&lt;MainMenu&gt;d&#95;&#95;191</code> (7892) | `0x9c5c00` |
| `TarkovApplication::LoadCharacterSelectionBootstrap` | `0x97b8d0` | — | — |
| `TarkovApplication::LoadCharacterSelectionData` | `0x97ba70` | — | — |
| `CharacterSelectionScreenController::SubmitAsync` | `0x13f0cc0` | <code>&lt;SubmitAsync&gt;d&#95;&#95;43</code> (14117) | `0x13f1500` |
...
UNBOXED.** MEASURED-BY-USE: <code>R fields &lt;SubmitAsync&gt;d&#95;&#95;43</code> reports
<code>profileData@0x30 / &lt;&gt;4&#95;&#95;this@0x38 / gameMode@0x40</code>, while `R disasm 0x13f1500`
...
### 1.5 Stage 2 — `TarkovApplication::StartTask` (<code>&lt;StartTask&gt;d&#95;&#95;85</code>)
...
**CORRECTION TO A TEMPTING MISREADING.** <code>&lt;StartTask&gt;b&#95;&#95;85&#95;0</code> `@0x987c40` is
...
<code>R fields &lt;RunInitialLobbyFlow&gt;d&#95;&#95;121</code> (subtract 0x10 for the unboxed body):

| table | unboxed | field |
|---|---|---|
| `0x10` | `0x00` | <code>&lt;&gt;1&#95;&#95;state</code> int |
| `0x18` | `0x08` | <code>&lt;&gt;t&#95;&#95;builder</code> |
| `0x30` | `0x20` | <code>&lt;&gt;4&#95;&#95;this</code> TarkovApplication |
| `0x38` | `0x28` | <code>&lt;bootstrap&gt;5&#95;&#95;2</code> CharacterSelectionBootstrapResult |
| `0x48` | `0x38` | <code>&lt;overriddenGameMode&gt;5&#95;&#95;3</code> Nullable\&lt;EGameMode\> |
| `0x50` | `0x40` | <code>&lt;inRaidResult&gt;5&#95;&#95;4</code> **CharacterSelectionResult** (24 bytes) |
| `0x68` | `0x58` | <code>&lt;&gt;u&#95;&#95;1</code> TaskAwaiter |
| `0x70` | `0x60` | <code>&lt;&gt;u&#95;&#95;2</code> TaskAwaiter\&lt;CharacterSelectionBootstrapResult\> |
| `0x78` | `0x68` | <code>&lt;&gt;u&#95;&#95;3</code> TaskAwaiter\&lt;bool\> |

MEASURED `R fields CharacterSelectionBootstrapResult`:
<code>&lt;Profiles&gt;k&#95;&#95;BackingField@0x10 (CharacterSelectionDataResponse)</code>,
<code>&lt;SeasonalPerks&gt;k&#95;&#95;BackingField@0x18</code>.

MEASURED `R disasm 0x9d7fb0 --to 0x9d8940`. In body order (`rsi` = the unboxed
machine, `r12` = <code>&lt;&gt;4&#95;&#95;this</code>):
...
<code>Dictionary&lt;EGameMode, CharacterSelectionProfileData&gt;</code>** — MEASURED
...
[`abi/aowlspt_modeskip.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_modeskip.h).** MEASURED `R fields EFT.ECharacterSelectionProfileStatus`
...
and <code>R fields &lt;ExecuteCharacterSelection&gt;d&#95;&#95;131</code>, where `result` occupies
...
| Member | RVA | sharedness |
|---|---|---|
| <code>.ctor(data, startupFlow, profileId, Nullable&lt;EGameMode&gt;, seasonalPerks, canGoBack)</code> | `0x13f0530` | UNIQUE |
| <code>Task&lt;CharacterSelectionResult&gt; get&#95;CompletionTask()</code> | `0x13f04e0` | UNIQUE |
...
| <code>Nullable&lt;EGameMode&gt; get&#95;CurrentGameMode()</code> | `0x690cb0` | **SHARED x147** |
...
| Offset | Field |
|---|---|
| `0x48` | <code>&lt;StartupFlow&gt;k&#95;&#95;BackingField</code> bool |
| `0x49` | <code>&lt;CanGoBack&gt;k&#95;&#95;BackingField</code> bool |
| `0x50` | <code>&lt;ProfileId&gt;k&#95;&#95;BackingField</code> string |
| `0x58` | <code>&lt;CurrentGameMode&gt;k&#95;&#95;BackingField</code> Nullable\&lt;EGameMode\> |
| `0x60` | **`_completion` TaskCompletionSource\&lt;CharacterSelectionResult\>** |
| `0x68` | <code>&lt;Data&gt;k&#95;&#95;BackingField</code> CharacterSelectionDataResponse |
| `0x70` | <code>&lt;SeasonalPerks&gt;k&#95;&#95;BackingField</code> SeasonalPerksData |
...
MEASURED `R disasm 0x13f1500 --to 0x13f1830` — <code>&lt;SubmitAsync&gt;d&#95;&#95;43::MoveNext</code>,
in source order (unboxed: `state@0x0`, `builder@0x8`, `profileData@0x20`,
<code>&lt;&gt;4&#95;&#95;this@0x28</code>, `gameMode@0x30`, <code>&lt;&gt;u&#95;&#95;1@0x38</code>):
...
<code>TryCloseScreen(bool forced, EScreenOrder order) -&gt; Task&lt;bool&gt;</code> is declared on
...
<code>TaskCompletionSource&lt;CharacterSelectionResult&gt;.TrySetResult</code>, preceded by a
...
(recorded in [`abi/aowlspt_modeskip.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_modeskip.h)). Every one of those preconditions
...
MEASURED <code>R fields &lt;ExecuteCharacterSelection&gt;d&#95;&#95;131</code> (subtract 0x10 unboxed):
`result@0x30 (24 bytes)`, `startupFlow@0x48`, <code>&lt;&gt;4&#95;&#95;this@0x50</code>.
...
<code>&lt;MainMenu&gt;d&#95;&#95;191::MoveNext +0x724</code> and <code>&lt;Run&gt;d&#95;&#95;184::MoveNext +0x1e7d</code>.
...
return site`), <code>&lt;InitPreloaderUI&gt;b&#95;&#95;114&#95;2 @0x988070 +0x2f</code>, and
<code>&lt;ShowLegacyLoginScreen&gt;d&#95;&#95;112::MoveNext @0x9dcff0 +0x335</code>.

MEASURED `R callers 0x979a10` — `ShowProfileLoadingScreen` has two:
<code>&lt;CreateBackend&gt;d&#95;&#95;102::MoveNext +0x90f</code> and
<code>&lt;ExecuteCharacterSelection&gt;d&#95;&#95;131::MoveNext +0x3a1</code>.
...
([`host/Aowlspt.Host.Il2Cpp/modload.nim`](https://github.com/aoughwl/aowlspt/blob/main/host/Aowlspt.Host.Il2Cpp/modload.nim), 2026-09-02): aowlspt mods are
...
| **H2** — take the bypass, but return `true` only once the mods are ready | **UNKNOWN — needs a live read (§8 Q3)** | [`abi/aowlspt_modeskip.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_modeskip.h) records "a blank background with no menu" for a *different* deferral mistake, so this must be checked, not assumed |
...
`R disasm 0x9dd570` (<code>&lt;ShowProfileLoadingScreen&gt;d&#95;&#95;108::MoveNext</code>) reaches
`EftScreenManager::get_Instance()` `@0x172dc10`. Calling it from the drain with
<code>rcx = &lt;the live TarkovApplication&gt;</code>, `rdx = MethodInfo* = 0` returns a `Task`
...
and a detour engine that cannot fix up <code>80 3D &lt;rel32&gt;</code> must refuse it rather
than patch it.
...
and `MenuLoadProfiler::Mark`, all of which carry <code>80 3D &lt;rel32&gt;</code> inside the
first 16 bytes (§5 T3).
...
* `data` arrives in `RCX` from the game's own <code>&lt;bootstrap&gt;5&#95;&#95;2.Profiles</code>.
* `data` **is a <code>Dictionary&lt;EGameMode, CharacterSelectionProfileData&gt;</code>** (§1.7),
...
The instantiated <code>Dictionary&lt;EGameMode,CharacterSelectionProfileData&gt;</code> layout is
...
"we cannot know the enum values" refusal in [`abi/aowlspt_modeskip.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_modeskip.h).
...
relocator that fixes up <code>80 3D &lt;rel32&gt;</code>; if the engine cannot, it must refuse and
say so, exactly as `CharacterSelectionScreen::Show @0x13ef4d0` was refused
([`abi/aowlspt_modeskip.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_modeskip.h)).
...
`@0x4436490`. [`abi/aowlspt_modeskip.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_modeskip.h) records the measured consequence: a
...
`TIMEOUT`; <code>python tools/harness.py run --until "&lt;literal&gt;"</code> does.
...
`VirtualQuery`/`aowl_is_readable` on every hop; <code>a-&gt;b-&gt;c</code> is three checks.
...
1. `aowl_pro_verify` the 16-byte prologue of `0x97bbf0` against the **startup
   snapshot** ([`abi/aowlspt_prologue.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_prologue.h)), never against live memory. On mismatch:
...
6. When ready, and the wanted profile is a key of `data`:
   ...
   * write <code>result-&gt;GameMode = gameMode</code> (dword `+0x00`),
     <code>result-&gt;ProfileData = profileData</code> (qword `+0x08`),
     <code>result-&gt;Cancelled = 0</code> (byte `+0x10`);
...
* The detour fires **twice**, and the second time the player is thrown out of the
  ...
  in-menu switch at <code>&lt;OpenCharacterSelectionFromMenu&gt;d&#95;&#95;118 +0x8ef</code> was hijacked.
* `MenuScreen::Show` never fires, the host log stops progressing, and there is no
  ...
  <code>D:&#92;Aowlspt&#92;Logs&#92;&lt;ts&gt;&#92;</code> and look for `CharacterSelectionSeasonPanel`.
* The game reaches the menu with the **wrong profile**, and
  <code>python tools/dmpread.py &lt;Crash&#95;&#42;&gt;/crash.dmp</code> shows a small integer where a
...
1. **[`abi/aowlspt_modeskip.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_modeskip.h):** "`ECharacterSelectionProfileStatus`'s constant
   ...
   (§4.4).
2. **[`abi/aowlspt_modeskip.h`](https://github.com/aoughwl/aowlspt/blob/main/abi/aowlspt_modeskip.h):** treats `Submit @0x13f0bf0` as the thing to call.
...
3. **[`host/Aowlspt.Host.Il2Cpp/modload.nim`](https://github.com/aoughwl/aowlspt/blob/main/host/Aowlspt.Host.Il2Cpp/modload.nim)** header: "This is NOT injected into
...
<code>component &lt;statusField&gt; EFT.UI.LocalizedText</code>, and `label` on the same node to
...
<code>Dictionary&lt;EGameMode, CharacterSelectionProfileData&gt;</code>.** Not reachable offline
...
default values are encrypted — `R fields` prints <code>'&lt;undecoded:0xe&gt;'</code>. *Live
