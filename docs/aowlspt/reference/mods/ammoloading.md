...
Source: [`mods/ammoloading`](https://github.com/aoughwl/aowlspt/blob/main/mods/ammoloading).
...
Defined in [`mods/ammoloading/config.json`](https://github.com/aoughwl/aowlspt/blob/main/mods/ammoloading/config.json). The values shown are the **shipped defaults**, not what is currently deployed.
