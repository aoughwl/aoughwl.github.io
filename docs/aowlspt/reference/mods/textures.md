...
Source: [`mods/textures`](https://github.com/aoughwl/aowlspt/blob/main/mods/textures).
...
Defined in [`mods/textures/config.json`](https://github.com/aoughwl/aowlspt/blob/main/mods/textures/config.json). The values shown are the **shipped defaults**, not what is currently deployed.
