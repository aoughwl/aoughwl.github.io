...
Source: [`mods/morebots`](https://github.com/aoughwl/aowlspt/blob/main/mods/morebots).
...
Defined in [`mods/morebots/config.json`](https://github.com/aoughwl/aowlspt/blob/main/mods/morebots/config.json). The values shown are the **shipped defaults**, not what is currently deployed.
