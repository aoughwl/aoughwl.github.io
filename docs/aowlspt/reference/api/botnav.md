...
<small>Source: `aowl/src/aowlspt/botnav.nim` — 361 lines.</small>
...
<small>`aowl/src/aowlspt/botnav.nim:137`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:149`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:125`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:127`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:132`</small>
...
```nim
proc goTo*(id: int; x, y, z: float; reach: float = 1.0; sprint: bool = false; holdMs: int = 20000): BotCommand
```
...
<small>`aowl/src/aowlspt/botnav.nim:177`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:199`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:205`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:213`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:229`</small>

#### `sendBotTo`

```nim
proc sendBotTo*(id: int; x, y, z: float; reach: float = 1.0; sprint: bool = false; holdMs: int = 20000): Status
```


The one-liner: send a single bot to a point, replacing the command set.

<small>`aowl/src/aowlspt/botnav.nim:253`</small>

#### `sendBotsTo`

```nim
proc sendBotsTo*(id: int; x, y, z: float; reach: float = 1.0; sprint: bool = false; holdMs: int = 20000): Status
```


Alias for `sendBotTo` that reads better with `BotNavAll`.

<small>`aowl/src/aowlspt/botnav.nim:258`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:263`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:267`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:315`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:341`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:346`</small>
...
<small>`aowl/src/aowlspt/botnav.nim:353`</small>
